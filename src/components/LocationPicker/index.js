...
@scriptLoader(
  ['http://tools.climatesmartfarming.org/gddtool_react_v3/js/location-dialog-min.js',
   URL_google_api,
   'http://tools.climatesmartfarming.org/gddtool_react_v3/js/basil.min.js',
   'http://tools.climatesmartfarming.org/gddtool_react_v3/js/manage-local-storage.js'
  ],
)
  ...
  render() {
        return (
            <div className="location-input-div">
              ...
              <td>
              <LocationSummaryButton button_label="Summary" />
              </td>
              </tr>
              </tbody></table>
            </div>
